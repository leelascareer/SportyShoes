...
<body><%
	...
	<div style="align:center;">
		<center>***********ADD PRODUCT DETAILS***********</center>
	<form:form action="/addproduct" method="get" modelAttribute="productRequest">
	<label for="model_name"><b>Model Name:*</b></label>		
	<form:input id="model_name" type="text" path="model_name" required="true"/>
	<br><br>
	<label for="price"><b>Price:</b></label>		
	<form:input id="price" type="double" path="price" min="500.00" max="7999.99" step="0.01" required="true"></form:input>
	<br><br>
	<label for="color"><b>Colour:</b></label>		
	<form:input id="color" type="text" path="color" required="true"></form:input>
	<br><br>
	<label for="category"><b>Category:</b></label>		
	<form:select id="category" type="text" path="category" required="true">
	...
	<form:input type="number" path= "size"  min="2" max="12" step="1" required="true"></form:input>
	<label for="brand" cols="15"><b>Brand:</b></label>		
	<form:input id="brand" type="text" path="brand" required="true"></form:input>
	<label for="availability" ><b>Availability:</b></label>		
	<form:input id="Availability" cols="5" type="number" min="0" max="30" step="1" path="availability" required="true"></form:input>
	<br><br>
	<label for="details"><b>Details:</b></label>		
	<form:input id="details" cols="50" maxlength="50" type="text" path="details" required="true"></form:input>
	<br><br>
	<form:button style="background-color:blue;border-radius: 8px;color: white;" id="add" name="add" path="model_id" required="true">Add</form:button>
	</form:form>
	</div>
</body>
</html>