...
import com.ss.entity.OrderStatus;
...
public class OrderResponse {
	...
	public OrderResponse(int order_id, int model_id, int userid, int status_id,
	...
	public OrderResponse(int order_id, Product product, User user) {
		super();
		this.order_id = order_id;
		this.product = product;
		this.user = user;
	...
	public OrderResponse(int order_id, int model_id, int status_id,
